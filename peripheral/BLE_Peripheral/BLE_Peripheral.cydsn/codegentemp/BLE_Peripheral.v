...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e098d689-59c6-4db7-9d38-b989ad465202"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__output_pin_3_net;
	wire [0:0] tmpFB_0__output_pin_3_net;
	wire [0:0] tmpIO_0__output_pin_3_net;
	wire [0:0] tmpINTERRUPT_0__output_pin_3_net;
	electrical [0:0] tmpSIOVREF__output_pin_3_net;

	cy_psoc3_pins_v1_10
		#(.id("4359b48e-749a-49e9-830d-fe876dc84f21"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		output_pin_3
		 (.oe(tmpOE__output_pin_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__output_pin_3_net[0:0]}),
		  .io({tmpIO_0__output_pin_3_net[0:0]}),
		  .siovref(tmpSIOVREF__output_pin_3_net),
		  .interrupt({tmpINTERRUPT_0__output_pin_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__output_pin_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
